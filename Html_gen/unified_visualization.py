...
def generate_unified_visualization(modifications_root, output_file='unified_visualization.html', videos_per_row=4):
    ...
    data_list = [
        #xintong
        "dobbe",  "uiuc_d3field","fmb", "aloha_mobile", "berkeley_fanuc_manipulation", "io_ai_tech",
        "droid",  "robo_set",  "utaustin_mutex",
        "cmu_playing_with_food",
        "cmu_play_fusion", "cmu_stretch","mimic_play","kuka",
        # qirui
        "bc_z",
        "ucsd_pick_and_place_dataset_converted_externally_to_rlds", 
        "roboturk", "nyu_franka_play_dataset_converted_externally_to_rlds", 
        "fractal20220817_data", "cmu_franka_exploration_dataset_converted_externally_to_rlds"
        # jiahe
